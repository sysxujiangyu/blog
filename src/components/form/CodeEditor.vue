<template>
	<div class="code-editor-box" :style="{ '--code-box-width': codeBoxWidth + 'px' }">
		<div class="menu">
			<ul>
				<li v-if="props.close" @click="closed">html</li>
		...
		<div class="code-box">
			<div class="item" v-for="item in codeBoxs" :style="{ height: codeBoxHeight + '%', display: item.isShow ? 'block' : 'none' }">
		...
		<div class="output-box">
			<div class="bar" @mousedown="gtouchstart" @mousemove="gtouchmove" @mouseup="gtouchend" @mouseover="gtouchend"></div>
...
const emit = defineEmits(['htmlChange', 'cssChange', 'jsChange', 'close']);
